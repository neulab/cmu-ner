...
LEMMA = Lookup(("/home/data/LoReHLT17/internal/Morph/Orm/v4/orm_lexicon.txt",
                "/home/data/LoReHLT17/internal/Morph/Orm/v4/orm_lexicon_wikibooks.txt",
                "/home/data/LoReHLT17/internal/Morph/Orm/v4/lexicon_supplement.txt"), Tex / Mor / Lem, Glo / Cit / Nat)
...
NTexMor = lambda x: Tex / Mor(x) | After("r", Tex) + Tex("r" + x[1:]) + Mor(x) | (
After("l", Tex) + Tex("l" + x[1:]) + Mor(x)) | Truncate("t", Tex) + Tex("n") + Tex / Mor(x) | Truncate("x", Tex) + Tex(
    "n") + Tex / Mor(x) | Truncate("d", Tex) + Tex("n") + Tex / Mor(x) | Truncate("dh", Tex) + Tex("n") + Tex / Mor(
    x) | Truncate("s", Tex) + Tex("f") + Tex / Mor(x)
TTexMor = lambda x: Tex / Mor(x) | After("(b|g|d)", Tex) + Tex("d" + x[1:]) + Mor(x) | After("(x|q)", Tex) + Tex(
    "x" + x[1:]) + Mor(x) | Truncate("dh", Tex) + Tex("t") + Tex / Mor(x) | Truncate("s", Tex) + Tex("f") + Tex / Mor(x)
...
VERB_STEM = LEMMA + Truncate("u", Tex) | LEMMA + Truncate("chu", Tex) + Tex / Mor("dh") | LEMMA + Truncate("chuu",
                                                                                                           Tex) + Tex / Mor(
    "t")
...
pairs = []
pairs = [("taatuun", "taatuu-NOM"), ("qilleensi", "qilleensa-NOM"), ("jaballi", "jabala-M.NOM"), ("afaan", "afaan-NOM"),
         ("loltoonni", "loltoota-M.NOM"), ("namichi", "namicha-NOM"), ("waantooti", "waantoota-NOM"),
         ("namichaa", "namicha-GEN"), ("Caaltuu", "Caaltuu-GEN"), ("afaanii", "afaan-GEN"), ("namichaa", "namicha-DAT"),
         ("intalaaf", "intala-DAT"), ("sareef", "saree-DAT"), ("baruuf", "baruu-DAT"), ("bishaaniif", "bishaan-DAT"),
         ("sareedhaa", "saree-DAT"), ("sareedhaaf", "saree-DAT"), ("Caaltuutti", "Caaltuu-DAT"),
         ("harkaan", "harka-INST"), ("halkaniin", "halkan-INST"), ("Oromotiin", "Oromo-INST"),
         ("yeroodhaan", "yeroo-INST"), ("bawuudhaan", "bawuu-INST"), ("Arsiitti", "Arsii-LOC"),
         ("harkatti", "harka-LOC"), ("guyyaatti", "guyyaa-LOC"), ("jalatti", "jala-LOC"), ("biyyaa", "biyya-ABL"),
         ("Finfinneedhaa", "Finfinnee-ABL"), ("Hararii", "Harar-ABL"), ("bunaatii", "bunaa-ABL"),
         ("manoota", "mana-PL"), ("hiriyoota", "hiriyaa-PL"), ("barsiisota", "barsiisaa-PL"),
         ("barsiisoota", "barsiisaa-PL"), ("waggaawwan", "waggaa-PL"), ("laggeen", "laga-PL"), ("ilmaan", "ilma-PL"),
         ("namicha", "nama-M.DEF"), ("muzicha", "muzii-M.DEF"), ("durbittii", "durba-F.DEF"), ("ilkaan", "ilka-PL"),
         ("waantoota", "waanta-PL"), ("guyyawwan", "guyyaa-PL"), ("gaarreen", "gaara-PL"), ("laggeen", "laga-PL"),
         ("mukkeen", "muka-PL"), ("waggottii", "waggaa-PL"), ("kitaabolii", "kitaaba-PL"),
         ("yunivarsitichaan", "yunivarsiti-DEF-GEN"), ("adeema", "m"), ("adeemta", "a"), ("adeemti", "a"),
         ("adeemna", "a"), ("Finfinne", "Addis Ababa"), ("Biraazil", "brazil")]
